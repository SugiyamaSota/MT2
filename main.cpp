...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(0, kRowHeingt * 5, resultSubtract, "Subtract");
		MatrixScreenPrintf(0, kRowHeingt * 5 * 2, resultMultiply, "Multiply");
		MatrixScreenPrintf(0, kRowHeingt * 5 * 3, resultInverseM1, "InverseM1");
		MatrixScreenPrintf(0, kRowHeingt * 5 * 4, resultInverseM2, "InverseM2");
		MatrixScreenPrintf(kColumnWidth * 5, 0, resultTransposeM1, "TransposeM1");
		MatrixScreenPrintf(kColumnWidth * 5, kRowHeingt * 5, resultTransposeM2, "TransposeM2");
		MatrixScreenPrintf(kColumnWidth * 5, kRowHeingt * 5 * 2, resultIdentity, "Identity");
		///
		/// ↑更新処理ここまで
		///
